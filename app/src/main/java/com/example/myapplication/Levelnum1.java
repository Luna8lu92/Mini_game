...
public class Levelnum1 extends AppCompatActivity {
    ...
    public void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_levelnum1);

        //вызов диалогового окна
        dialog = new Dialog(this);
        dialog.requestWindowFeature(Window.FEATURE_NO_TITLE);
        dialog.setContentView(R.layout.startdial);
        ...
        btnclose.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                try {
                    Intent intent = new Intent(Levelnum1.this, MainNumbers.class);
        ...
        btncontinue2.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                try {
                    Intent intent = new Intent(Levelnum1.this, MainLevelNum2.class);
                    startActivity(intent);
                }catch (Exception e){}
                dialog2.dismiss();
            }
    ...
    public void clickFinish2(View view) {
     ...
     if (number.equals(nomer)) {
            ...
            Toast toast = Toast.makeText(Levelnum1.this, "Пожалуйста, введите число", Toast.LENGTH_LONG);
            toast.show();
